...
python3 detect11_web.py --weights yolov5n.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream2'
python3 detect11_web.py --weights yolov5s.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream1'
python3 detect11_web.py --weights yolov5m.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream1'
python3 detect11_web.py --weights yolov5l.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream1'
python3 detect11_web.py --weights yolov5x.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream1'
python3 detect11_web.py --weights yolov5s.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@172.30.1.60:554/stream2'

gunicorn -b 0.0.0.0:7000 detect11_web:detect_app -k gthread -w 1 --threads 2
...
class DetcInfer():
    ...
    def run(self, stream_or_backstage=''):
        print('{} # # 07 Start model infer!'.format(datetime.now()))

        NumNum = 0
        for path, im, im0s, vid_cap, s in self.dataset:
            NumNum += 1
            print('{} # NumNum : {} stream_or_backstage:{}'.format(datetime.now(), NumNum, stream_or_backstage))
            ...
            for i, det in enumerate(pred):  # per image
                ...
                if len(det):
                    ...
                    # print(s)
                    if stream_or_backstage == 'backstage':
                        if 'car' in str(s) :
            ...
            if stream_or_backstage == 'stream':
                ret, buffer = cv2.imencode('.jpg', im0)
                frame = buffer.tobytes()
                yield (b'--frame\r\n'b'Content-Type: image/jpeg\r\n\r\n' + frame + b'\r\n')  # concat frame one by one and show result
            else :
                temp = '{} # string from backstage NumNum : {}'.format(datetime.now(), NumNum)
                yield temp
...
def video_feed():
    ...
    detc_generator = yolo_detector.run('stream')
