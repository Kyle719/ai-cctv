...
python3 detect10.py --weights yolov5n.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream2'
python3 detect10.py --weights yolov5s.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream1'
python3 detect10.py --weights yolov5m.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream1'
python3 detect10.py --weights yolov5l.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream1'
python3 detect10.py --weights yolov5x.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@183.106.132.155:554/stream1'
python3 detect10.py --weights yolov5s.pt --save-txt --source 'rtsp://prezzie77:1q2w3e4r5t@172.30.1.60:554/stream2'

gunicorn -b 0.0.0.0:7000 detect10:detect_app -k gthread -w 1 --threads 2
...
def video_stream():
    yolo_detector.rtsp_requested = True
    print('{} @ @ 1 request:{}'.format(datetime.now(), request))
    print('{} @ @ 1 yolo_detector.rtsp_requested:{}'.format(datetime.now(), yolo_detector.rtsp_requested))
    """Video streaming home page."""
    return render_template('index2.html')

@detect_app.route('/detect_wo_stream')
def detect_wo_stream():
    print('{} @ @ 1 detect_wo_stream request:{}'.format(datetime.now(), request))
    yolo_detector.rtsp_requested = False
    t = threading.Thread(target=yolo_detector.run_n_save)
    t.start()
